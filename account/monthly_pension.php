...
$total_paye = $db->connection->query("SELECT sum(pension) pension_total from sliprecord where month = '$months' and year='$year'"); 
$row_total = $total_paye->fetch_assoc();

echo '<tfoot>
<th colspan="3" class="bg-dark" style="color:#ffffff;">Total</th>
<th>'.number_format($row_total['pension_total'],2).'</th>
</tfoot>
